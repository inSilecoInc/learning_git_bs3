...
abstract: |
  The goal of the exercise is to work collaboratively using GitHub to create a CSAS document with `csasdown`. By the end of this exercise, you should know how to create a DFO Research Document using `csasdown`, and how to work collaboratively on the document by creating and reviewing pull requests on GitHub. 
